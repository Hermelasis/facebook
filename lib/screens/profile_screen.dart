...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  // Navigation
  int _selectedIndex = 0; // 0 = Profile (Current), but we want a global nav? 
  ...
  Widget build(BuildContext context) {
    ...
    final String avatarUrl = _userModel?.avatarUrl ?? 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80';
            ...
            Expanded(
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(_friends[index]['img']), 
                    fit: BoxFit.cover
                  ),
                ),
              ),
